...
const SIMPLE_TAG_DEFINITIONS: {[key: string]: HtmlTagDefinition} = {
  'area': new HtmlTagDefinition({isVoid: true}),
  'embed': new HtmlTagDefinition({isVoid: true}),
  'link': new HtmlTagDefinition({isVoid: true}),
  'img': new HtmlTagDefinition({isVoid: true}),
...
export function getSimpleHtmlTagDefinition(tagName: string): HtmlTagDefinition {
  return SIMPLE_TAG_DEFINITIONS[tagName.toLowerCase()] || _DEFAULT_TAG_DEFINITION;
}
