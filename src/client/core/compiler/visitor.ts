...
// // } from '../view/types';
// import { ViewDefinition, ViewData, BindingDef, QueryValueType } from '../view/types';
...
//   private _getQueryValue(element: Element, view: ViewData | null, query: /*QueryBindingDef*/ any) {
